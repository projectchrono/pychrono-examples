...
# TestModels/MiniExamples/ObjectMassPoint.py:
# a free 3D mass point with reference x=1, initial displacement 0.5, and
# initial x velocity 0.5. After 1 s, x is 2.
...
def run_visual(duration, step):
    ...
    vis.SetWindowTitle("EXUDYN port: ObjectMassPoint.py")
    vis.Initialize()
    vis.AddSkyBox()
...
def main():
    ...
    print("EXUDYN port: ObjectMassPoint.py -> PyChrono free mass point")
    if args.no_vis:
