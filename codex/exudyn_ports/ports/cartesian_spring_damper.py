...
# Reproduces the intent of EXUDYN Examples/cartesianSpringDamper.py:
# a linear mass-spring-damper oscillator driven by a constant x-force, with an
...
def build_system():
    ...
    attach_spring_visual(sys, spring, 0.05, 80, 15, color(0.85, 0.18, 0.12))
...
def run_visual(duration, step):
    ...
    vis.SetWindowTitle("EXUDYN port: cartesianSpringDamper.py")
    vis.Initialize()
    vis.AddSkyBox()
...
def main():
    ...
    print("EXUDYN port: cartesianSpringDamper.py -> PyChrono constrained TSDA oscillator")
    if args.no_vis:
